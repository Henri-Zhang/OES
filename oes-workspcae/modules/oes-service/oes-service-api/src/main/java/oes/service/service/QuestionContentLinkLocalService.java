...
/**
 * Provides the local service interface for QuestionContentLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see QuestionContentLinkLocalServiceUtil
...
public interface QuestionContentLinkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QuestionContentLinkLocalServiceUtil} to access the question content link local service. Add custom service methods to {@link oes.service.service.impl.QuestionContentLinkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<QuestionContentLink> findRecentUpdateQuestionContentLinks(
		int count);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<QuestionContentLink> getQuestionContentLinks(int start, int end);
	...
	*/
	...
	public QuestionContentLink addQuestionContentLink(
	...
	*/
	public QuestionContentLink createQuestionContentLink(long questionOrder);
	...
	*/
	...
	public QuestionContentLink deleteQuestionContentLink(long questionOrder)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public QuestionContentLink deleteQuestionContentLink(
		QuestionContentLink questionContentLink);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public QuestionContentLink fetchQuestionContentLink(long questionOrder);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public QuestionContentLink getQuestionContentLink(long questionOrder)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public QuestionContentLink updateQuestionContentLink(
		QuestionContentLink questionContentLink);
}