...
/**
 * Provides the local service interface for ExamQuestionLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExamQuestionLinkLocalServiceUtil
...
public interface ExamQuestionLinkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ExamQuestionLinkLocalServiceUtil} to access the exam question link local service. Add custom service methods to {@link priv.barrow.service.impl.ExamQuestionLinkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
