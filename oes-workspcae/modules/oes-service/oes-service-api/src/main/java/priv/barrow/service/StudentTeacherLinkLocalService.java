...
/**
 * Provides the local service interface for StudentTeacherLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StudentTeacherLinkLocalServiceUtil
...
public interface StudentTeacherLinkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StudentTeacherLinkLocalServiceUtil} to access the student teacher link local service. Add custom service methods to {@link priv.barrow.service.impl.StudentTeacherLinkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
