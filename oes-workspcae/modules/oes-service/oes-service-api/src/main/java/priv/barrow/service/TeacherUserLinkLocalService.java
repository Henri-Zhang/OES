...
/**
 * Provides the local service interface for TeacherUserLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TeacherUserLinkLocalServiceUtil
...
public interface TeacherUserLinkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TeacherUserLinkLocalServiceUtil} to access the teacher user link local service. Add custom service methods to {@link priv.barrow.service.impl.TeacherUserLinkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public TeacherUserLink addTeacherUserLink(TeacherUserLink teacherUserLink);
	...
	*/
	public TeacherUserLink createTeacherUserLink(long teacherNumber);
	...
	*/
	...
	public TeacherUserLink deleteTeacherUserLink(long teacherNumber)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public TeacherUserLink deleteTeacherUserLink(
		TeacherUserLink teacherUserLink);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TeacherUserLink fetchTeacherUserLink(long teacherNumber);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TeacherUserLink getTeacherUserLink(long teacherNumber)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public TeacherUserLink updateTeacherUserLink(
		TeacherUserLink teacherUserLink);
}