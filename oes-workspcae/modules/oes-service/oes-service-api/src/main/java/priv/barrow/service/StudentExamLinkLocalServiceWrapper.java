...
public class StudentExamLinkLocalServiceWrapper
	...
	*/
	...
	@Override
	public java.util.List<priv.barrow.model.StudentExamLink> findByExamRecordIdAndDone(
		long examRecordId, boolean done) {
		return _studentExamLinkLocalService.findByExamRecordIdAndDone(examRecordId,
			done);
	}
