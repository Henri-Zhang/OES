...
/**
 * Provides the local service interface for StudentExamLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StudentExamLinkLocalServiceUtil
...
public interface StudentExamLinkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StudentExamLinkLocalServiceUtil} to access the student exam link local service. Add custom service methods to {@link priv.barrow.service.impl.StudentExamLinkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
